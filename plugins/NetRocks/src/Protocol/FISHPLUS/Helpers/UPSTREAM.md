...
|---|---|---|---|---|
| `helper.sh`  | https://github.com/unxed/f4 | `plugins/netfox/fishplus/helper.sh`  | `a8cb0e48` (protocol lines printed with `printf`, not `echo`) | BSD-3-Clause (see the f4 repository) |
